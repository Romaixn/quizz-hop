...
class SignUpController extends AbstractRenderController
{
    ...
    public function post(Request $request): Response
    {
        ...
        try {
            ...
            return $this->render('auth/user_created.html.twig', ['uuid' => $uuid, 'email' => $email]);
        } catch (EmailAlreadyExistException $exception) {
            return $this->render('auth/register.html.twig', ['error' => $exception->getMessage()], Response::HTTP_CONFLICT);
        } catch (InvalidArgumentException $exception) {
            return $this->render('auth/register.html.twig', ['error' => $exception->getMessage()], Response::HTTP_BAD_REQUEST);
        }
    }
}
